...
def sc_main(w: World):
    ...
    return w.scene("main",
            ...
            _.do("視界の全てがチョークを寝かせて描いたような雨に覆われ、一歩ごとに体温が奪われる",
                ...
                "月も星も、",
                "電灯すら見当たらない",
                "鼓膜が震えても雨音しか分からず、いつしかここが道路の上ということすら忘れてしまいそうだ"),
            w.br(),
            eiji.think("――もう、三年になるのか"),
            w.br(),
            eiji.do("$junkoはよく笑う女だった",
                "その大きな口で、"),
            jun.talk("$eijiってほんとによく転ぶよね"),
            eiji.think("何もない場所で躓く彼を助け起こしては揶揄して笑った",
                "出会いのきっかけもそんな$Sを見た彼女の笑い声だ",
            ...
            eiji.do("彼女は同級生なのにしっかりしていてどこか姉のようでもあり、それでいて雨の中にはしゃいで飛び出すような無邪気さも持っていた",
                "どんなに雨が降っても$junkoが居れば太陽がもう一つあるようなものだ", "そう思っていた"),
            ...
            eiji.do("脇腹が捻れそうな不快な音を流して車は分離帯を抜け、",
                    "そのまま対抗車線の縁石に乗り上げて止まった"),
            eiji.do("視線を戻すとそこで彼女は微笑み、それから少し寂しそうに頷いた"),
            eiji.talk("お前は、お前は俺に生きろと、そう言うのか？"),
            eiji.do("けれど彼女は答えず、止まない雨に掻き消された"),
            eiji.do("雨は$Sをどこまでも濡らしていたが、まるで彼女に抱きしめられているかのように温もりを感じた"),
            w.symbol("（了）"),
