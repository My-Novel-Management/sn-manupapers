...
def sc_visit(w: World):
    ...
    return w.scene("人形師の館",
            ...
            yuki.do("と、女は言った"),
            w.br(),
            yuki.do("外灯一つだけで照らす薄暗い裏庭で、スコップが土を掘り返す音だけが響いている",
                "上着の袖を捲り上げた女の腕は白く、細いが逞しい",
...
def sc_memmory(w: World):
    ...
    return w.scene("昨日の記憶",
            ...
            hiro.talk("$meは君に謝った", "もう二度とはしないと、", "そう約束しただろう？", "それなのに君は"),
            yuki.talk("たった一度"),
            yuki.do("女は男の言葉を遮って口を開く",
                "きりっとした薄化粧の顔が苦い表情の男に向けられる"),
            yuki.talk("その一度で充分だと私は思うのです"),
            yuki.do("涼しげな声だったが女の表情は真剣そのものだった",
                "眉を立てることも寝かすこともせず、ただ真っ直ぐに向けられたその視線に男はたじろいだ"),
            yuki.talk("白い布を汚すには一滴の墨汁があれば良い、そう思いませんか？"),
            hiro.do("男は何か言おうとしたが、言葉を見つけられなかったのか、口を噤んだまま、女に勧められた紅茶のカップを手にし、それを飲んだ"),
            )
