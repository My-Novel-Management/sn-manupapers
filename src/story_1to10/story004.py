...
def sc_main(w: World):
    ...
    return w.scene("main",
            ...
            _.do("しかし気にすることなく「彼」は博士が動かなくなる直前の記憶を反芻する"),
            robber.be(),
            doc.be(),
            _.voice("$vector博士、研究成果はどこだ？"),
